    ...
    return `
        <div class="container mx-auto px-4 py-12">
            <div class="flex justify-between items-center mb-10 border-b pb-6">
                <div><h2 class="text-2xl font-bold text-[#1e3a2c] uppercase">Painel de Pesquisa</h2><p class="text-[10px] text-gray-500 font-bold uppercase">Sessão: ${app.currentUser}</p></div>
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <button @click="showProjectForm = true" class="bg-[#c5a059] text-[#1e3a2c] px-6 py-2 rounded font-bold text-[10px] uppercase shadow-lg">Publicar Pesquisa</button>
            </div>
                ...
                ${projects.map(p => `
                    <div class="p-8 rounded-lg shadow bg-white border-l-8 ${p.domainId == 1 ? 'border-blue-700' : (p.domainId == 2 ? 'border-green-700' : 'border-orange-700')}">
                        ...
                        <div class="bg-gray-50 p-4 rounded text-[11px]">
                            <h5 class="font-bold uppercase mb-2">Manifestações CRediT:</h5>
                ...
                <div class="bg-white p-8 rounded-xl max-w-2xl w-full">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex space-x-4">
                            <button @click="confirmPublish()" class="bg-[#1e3a2c] text-white px-6 py-2 rounded font-bold uppercase text-xs">Publicar</button>
...
// FUNÇÃO DE LOGIN (Corrige o erro de renderização do módulo researcher_login)
        ...
        <div class="py-32 flex justify-center">
            <div class="bg-white p-12 rounded-xl shadow-2xl border-t-8 border-[#c5a059] w-full max-w-md text-center">
                ...
                <div class="space-y-5">
                    ...
                    <button @click="handleLogin()" class="w-full bg-[#1e3a2c] text-white font-bold py-3 rounded uppercase text-xs hover:bg-black transition">Entrar</button>
                </div>
            </div>
        </div>`;
}
